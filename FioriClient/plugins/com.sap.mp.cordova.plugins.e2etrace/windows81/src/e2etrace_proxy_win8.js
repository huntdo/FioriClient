var exec = require("cordova/exec");
    ...
    module.exports = {
        _nativeE2ETraceInstance: new SAP.EndToEndTrace.EndToEndTrace(),
        ...
        uploadTrace: function (successCB, errorCB, args) {
            ...
            module.exports._nativeE2ETraceInstance.uploadTrace(connectionInfo).then(function () {
                console.log("Upload log call succeeded");
                successCB();
            }, 
            function () {
                console.error("Upload log call failed");
                errorCB();
            })
        }
    }
    require("cordova/windows8/commandProxy").add("E2ETrace", module.exports);
