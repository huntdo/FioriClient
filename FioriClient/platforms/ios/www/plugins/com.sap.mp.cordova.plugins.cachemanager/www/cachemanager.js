cordova.define("com.sap.mp.cordova.plugins.cachemanager.CacheManager", function(require, exports, module) { // 3.8.0
var exec = require('cordova/exec'),
     ...
     * plugins>\cachemanager<br/> <br/> To remove the
    ...
    module.exports = {
         ...
         *            required.
         * @param {Array.
         *            <string>} [checkForUpdatesEvents] Array of
         *            strings representing events that should
         *            trigger a check for application updates.
         * @example sap.CacheManager.setUrl('https://m.sap.de/sap/bc/ui5_ui5/ui2/ushell/shells/abap/FioriLaunchpad.html');
         */
        setUrl: function (url,
    ...
    module.exports.onnoviewerfound = function (parameters) {
        ...
        if (!bundle) {
            ...
            i18n.load({
                path: "plugins/com.sap.mp.cordova.plugins.cachemanager/www"
            }, function(i18nBundle) {
                  bundle = i18nBundle;
                  reportNoViewer();
            });
    ...
    document.addEventListener('deviceready', module.exports.setCheckForUpdatesEvents, false);
