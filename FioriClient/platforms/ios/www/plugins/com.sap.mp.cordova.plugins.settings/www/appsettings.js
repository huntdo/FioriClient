cordova.define("com.sap.mp.cordova.plugins.settings.AppSettings", function(require, exports, module) { 
    ...
    function _getConnectionURL(info) {
        ...
        return scheme + "://" + host + (path?path:"/") + "odata/applications/v1/" + sap.Logon.applicationId + "/Connections('" + info.applicationConnectionId + "')";
    };
    ...
    */
    function _getConnectionURLForRegistration(info) {
        ...
        return scheme + "://" + host + (path?path:"/") + "odata/applications/v1/" + sap.Logon.applicationId + "/Connections";
    };
