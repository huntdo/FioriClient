cordova.define("com.sap.mp.cordova.plugins.settings.Settings", function(require, exports, module) { // 3.8.0
...
SettingsExchange.prototype.initNoLoadPolicy = function()
{
   if (sap.AppPreferences != undefined) {
        sap.AppPreferences.getPreferenceValue('fioriURL',
            function(url){
               exec(successCallback, errorCallback, "SMPSettingsExchangePlugin", "setFioriURL" , [url]);
            },
            function(){});
    }
